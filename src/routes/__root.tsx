  ...
  head: () => ({
    meta: [
      ...
      { title: "Qatalogue Biofuels — Industrial Biomass Fuel Supply in Kenya" },
      {
        name: "description",
        content:
          "Qatalogue Limited turns biomass and waste into reliable industrial energy — wood chips, industrial firewood and briquettes for Kenyan industry.",
      },
      { name: "author", content: "Qatalogue Limited" },
      { property: "og:title", content: "Qatalogue Biofuels — Industrial Biomass Fuel Supply" },
      {
        property: "og:description",
        content: "Wood chips, industrial firewood and briquettes for Kenyan industry.",
      },
